const variables = {
    en: {
        connect: 'Connect',
        frens_collection: 'frens collection',
        frens_content: 'We are five full-time Cosmonauts with technical backgrounds. This year, we decided to set up validators to contribute to the growing.',
        claim: 'Claim',
        purchase: 'Purchase',
